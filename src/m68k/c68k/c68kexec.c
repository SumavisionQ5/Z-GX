...
uint32_t g_derail_from = 0;
uint32_t g_derail_to = 0;
uint32_t g_derail_areg[8] = {0};
uint32_t g_derail_dreg[8] = {0};
uint32_t g_trace_pc[64] = {0};
uint16_t g_trace_op[64] = {0};
int g_trace_idx = 0;
int g_trace_frozen = 0;
