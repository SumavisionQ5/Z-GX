...
void osd_FPSDraw(u32 fps)
{
	...
	{ extern u32 snd_muted; u32 numc; { extern u32 drc_inval_count; if (snd_muted) numc = sprintf(tstr, "FPS:%2d SND OFF I:%u", fps, drc_inval_count); else numc = sprintf(tstr, "FPS:%2d I:%u", fps, drc_inval_count); drc_inval_count = 0; }
	...
	{ extern u32 snd_muted; GX_SetDispCopySrc(0, 0, (snd_muted ? 22 : 14)*16, 16); }
	SVI_CopyXFB(32, 24);
}
